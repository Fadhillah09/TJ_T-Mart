            ...
            {isUser && (
              <>
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="nav-badge absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] flex items-center justify-center bg-[#5B000B] text-white text-[10px] font-semibold rounded-full ring-2 ring-white animate-pulse">
