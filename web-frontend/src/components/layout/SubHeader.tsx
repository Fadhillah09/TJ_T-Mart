      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-10 text-sm overflow-hidden">
          ...
          <ul className="flex items-center gap-1 font-semibold h-full">
            {links.map((link, index) => (
              <div key={link.name} className="flex items-center h-full">
                {index > 0 && (
                  <li className="hidden sm:block h-5 w-[1px] bg-gradient-to-b from-transparent via-[#E7BD8A]/40 to-transparent" />
                )}
                <li className={`${link.mobileHidden ? "hidden sm:block" : ""} h-full flex items-center`}>
                  <a
                    href={link.url}
                  ...
                  >
                    ...
                    <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[3px] bg-gradient-to-r from-[#dc2626] via-[#E7BD8A] to-[#dc2626] transition-all duration-500 group-hover:w-full"></span>
                  </a>
                </li>
              </div>
            ))}
          ...
          <button
            ...
            className="mart-button-premium crystal-shine btn-click-effect flex items-center gap-2 px-3 h-8 rounded-full text-white transition-all duration-300 group overflow-hidden"
          >
            ...
            <div className="p-1.5 bg-gradient-to-br from-[#5B000B] to-[#b91c1c] rounded-full group-hover:from-[#dc2626] group-hover:to-[#DB4B3A] transition-all duration-300 shadow-lg border border-white/10">
              <div className="floating-icon text-[#E7BD8A] group-hover:text-white transition-colors w-3.5 h-3.5">
            ...
            <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#E7BD8A] to-[#E68757] group-hover:from-white group-hover:to-[#fee2e2] transition-all duration-300 drop-shadow-md max-w-[140px] truncate whitespace-nowrap">
