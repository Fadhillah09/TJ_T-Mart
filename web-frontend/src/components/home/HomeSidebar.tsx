    ...
    <aside className="lg:col-span-4 xl:col-span-3">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-[108px]">
        <div className="mb-6 pb-6 border-b border-gray-100">
          ...
          ) : (user.penghuni_asrama || user.nomor_kamar || user.lokasi) ? (
            <div className="flex flex-wrap gap-2 mb-4">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-gray-50 text-xs font-bold text-gray-700">
                ...
                {user.lokasi?.nama_gedung
                  ...
                  : user.lokasi?.nama_lokasi || "Asrama"}
              </div>
              {user.nomor_kamar && (
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-gray-50 text-xs font-bold text-gray-700">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span className="material-symbols-outlined text-gray-400 text-lg group-hover:translate-x-1 transition-transform">chevron_right</span>
          </button>
