        ...
        <img
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src =
              `https://images.unsplash.com/photo-1599599810694-e1b42fc85b72?w=400&h=400&fit=crop&q=80`;
            setImageLoaded(true);
          }}
        />
        ...
        <div className="mb-2 sm:mb-3">
          ...
          {produk.produk_marts && produk.produk_marts.length > 0 && (
            <div className="mt-1.5 flex flex-wrap gap-1">
              {produk.produk_marts.map((pm: any) => (
                <span key={pm.mart_id} className="text-[9px] bg-red-50 text-[#930014] px-1.5 py-0.5 rounded-full font-semibold border border-red-200/40">
                  {pm.mart?.nama_mart}
                </span>
              ))}
            </div>
