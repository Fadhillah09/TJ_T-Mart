...
class RiwayatPembelianController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return $this->success($orders, 'Riwayat pembelian berhasil diambil');
    }
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'alamat_pengantaran' => ['required_if:tipe_layanan,delivery', 'nullable', 'string'],
    ...
    public function adminIndex(Request $request): JsonResponse
    {
        ...
        return $this->success($orders, 'Daftar pesanan admin berhasil diambil');
    }
    ...
    public function updateStatus(Request $request, string $id): JsonResponse
    {
        $validated = $request->validate([
            ...
            'kurir_id' => ['required_if:status,delivering', 'nullable', 'exists:users,id'],
        ]);
        ...
        return $this->success($order->fresh()->load(['user', 'kurir', 'details']), 'Status pesanan berhasil diperbarui');
    }
}
